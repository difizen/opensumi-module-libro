...
export const ComponentsSampleView = () => {
    ...
    return [
      {
        ...
        children: [],
        // CDN icon
        iconClassName: iconService.fromIcon(
          '',
          `https://img.alicdn.com/imgextra/i2/O1CN01yJI0Je20XTPIuU6or_!!6000000006859-2-tps-128-128.png`,
        ),
      },
      {
        label: `node ${treenodeCounter.current++}`,
  ...
  return (
    <div className={styles.components_wrap}>
      ...
      <Drop
        className={'kt-menu'}
        overlay={<div className={styles.menu_item}>I'm a Menu Item</div>}
        trigger={['click']}
      >
